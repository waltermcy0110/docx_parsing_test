...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (XWPFDocument document = new XWPFDocument(
            ...
            // tables are not captured by XWPFParagraph
            // online sources and https://blog.csdn.net/hwtwilight/article/details/151837532
            for (IBodyElement element: document.getBodyElements()) {
                // paragraphs: text, equations, etc
                if (element instanceof XWPFParagraph) {
                    // oh lmao i kept the original loop


                    // for (XWPFParagraph paragraph: list) {
                    XWPFParagraph paragraph = (XWPFParagraph) element; // just doing this for convenient not readability loll
...
//                        System.out.println(paragraph.getCTP().xmlText());
                    ...
                    do {
                        ...
                        if (xmlobj instanceof CTR) {
                            ...
                            // TODO: handle images since images are inside runs
                        }
